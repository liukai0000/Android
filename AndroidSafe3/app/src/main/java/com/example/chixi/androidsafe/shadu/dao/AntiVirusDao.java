package com.example.chixi.androidsafe.shadu.dao;
...
public class AntiVirusDao {
    ...
    public static String checkVirus(String md5) {
        ...
        SQLiteDatabase db = SQLiteDatabase.openDatabase(
                "/data/data/com.example.chixi.androidsafe/files/antivirus.db"
                , null,
    ...
    public static String getDBVersionNum() {
        SQLiteDatabase db = SQLiteDatabase.openDatabase(
                "/data/data/com.example.chixi.androidsafe/files/antivirus.db", null,
                SQLiteDatabase.OPEN_READONLY);
